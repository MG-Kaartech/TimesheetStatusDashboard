		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgctimesheetdashboardui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgctimesheetdashboardui-display": {
								"semanticObject": "commgctimesheetdashboardui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.timesheetdashboardui",
									"url": sap.ui.require.toUrl("com/mgc/timesheetdashboardui")
								}
							}
						}
					}
